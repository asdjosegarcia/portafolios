    ...
    return (
        <section id="aboutSection" className='aboutSection__container'>
            <div className='aboutSection__info'>
                ...
                <h2 className='about__title about__title--skills'>Habilidades en programación</h2>
                <div className='about__skills__container'>
                    <h2 className='about__skills--subtitle'>Front-end:</h2>
                    ...
                    <h2 className='about__skills--subtitle'>Back-end y Bases de Datos:</h2>
                    <div className='skill__card'>
                        {/* prisma */}
                    ...
                    <h2 className='about__skills--subtitle'>Herramientas y Otras Tecnologías:</h2>
                    <div className='skill__card'>
                        {/* webpack */}
                    ...
                    <div className='skill__card '>
                        <img src='/img/icons/uml.png'></img>
                        <p>UML</p>
                    </div>
                    <div className='skill__card '>
                        <img src='/img/icons/BEM.png'></img>
                        <p>BEM</p>
                    </div>
                    <div className='skill__card'>
                        {/* arduino */}
